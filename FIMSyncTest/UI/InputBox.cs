...
namespace FIMSyncTest {
    ...
    public class InputBox {
        ...
        //_________________________________________________________________________________________________________
        static private string FormCaption { set { _formCaption = value; } } // property FormCaption
        //_________________________________________________________________________________________________________
        static private string FormPrompt { set { _formPrompt = value; } } // property FormPrompt
        //_________________________________________________________________________________________________________
        static private InputBoxResult OutputResponse { get { return _outputResponse; } set { _outputResponse = value; } } // property InputResponse
        //_________________________________________________________________________________________________________
        static private string DefaultValue { set { _defaultValue = value; } } // property DefaultValue
        //_________________________________________________________________________________________________________
        static private int XPosition { set { if ( value >= 0 ) _xPos = value; } } // property XPos
        //_________________________________________________________________________________________________________
        static private int YPosition {set { if ( value >= 0 ) _yPos = value; } } // property YPos
        #endregion
        }
    }
